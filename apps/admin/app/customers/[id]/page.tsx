    ...
    return (
        <div className="min-h-screen bg-slate-50 p-6 md:p-10 space-y-6">
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                {/* Back Navigation */}
                <Link href="/customers" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-orange-600 font-medium transition-colors">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        ...
                                                        {order.invoice && (
                                                            <div className="mt-2 flex justify-end">
                                                                <Link 
                                                                    href={`/sales/invoice/${order.invoice.id}`}
                                                                    target="_blank"
